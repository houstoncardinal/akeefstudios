...
export function InteractiveNebulaShader({
  ...
  useEffect(() => {
    ...
    // Ray-marched nebula fragment shader - customized for red/black theme
      ...
      void mainImage(out vec4 O, in vec2 fragCoord) {
        ...
        for (int i = 0; i <= 5; i++) {
          ...
          vec3 base = hasActiveReminders
            ? vec3(0.6,0.1,0.1) + vec3(4.0,0.5,0.3)*f
            : hasUpcomingReminders
            ? vec3(0.5,0.15,0.1) + vec3(3.0,1.0,0.5)*f
            : vec3(0.4,0.05,0.08) + vec3(3.5,0.8,0.6)*f;
